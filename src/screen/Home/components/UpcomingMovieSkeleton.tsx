...
const UpcomingMovieSkeleton = () => {
  ...
  return (
    <View style={styles.item}>
      ...
      <ShimmerBlock animatedValue={shimmerAnimation} style={styles.release} />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  release: {
    ...
    marginTop: 10,
    borderRadius: 5,
    backgroundColor: 'rgba(245,234,0,0.16)',
  },
});

export default React.memo(UpcomingMovieSkeleton);
