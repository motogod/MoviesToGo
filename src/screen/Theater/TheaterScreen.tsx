...
const styles = StyleSheet.create({
  ...
  cityItemReveal: {
    backgroundColor: 'rgba(216,169,79,0.14)',
    borderColor: 'rgba(244,210,142,0.36)',
    borderWidth: 1,
  ...
  emptyStateIconWrap: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(198,160,94,0.24)',
    marginBottom: 14,
  },
  emptyStateIcon: {
    width: 112,
  ...
  cinemaItemSelected: {
    backgroundColor: 'rgba(198,160,94,0.12)',
    borderColor: 'rgba(198,160,94,0.3)',
    borderRadius: 8,
    borderWidth: 1,
  },
  cinemaItemPressed: {
